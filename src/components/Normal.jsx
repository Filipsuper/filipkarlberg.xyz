  ...
  return (
    <main className="flex justify-center">
      <section className="w-full flex flex-col items-center p-0 mt-5 sm:p-10 sm:w-2/3">
        <header>
          <h1 className="text-5xl text-slate-800 bg-orange-300 p-2 rounded-xl">
            Filip Karlberg
          </h1>
        </header>
        <div className="flex flex-col my-10">
          ...
          <p>
            Hi, my name is Filip Karlberg. I am a web developer and programmer
            with a background in graphic design from Sweden who loves making
            websites. I am currently studying Engineering Preparatory Year on
            Chalmers University of Technology.
          </p>
          <p className="pt-10">
            I have experience in React aswell as other webdev libraries and I am
        ...
        <div className="flex flex-col w-full my-10">
          ...
          <div className="flex flex-row items-center">
            <BsDiscord /> <h3>karlbergg</h3>
          </div>
          <div className="flex flex-row items-center">
            <GrMail />
            <a className="underline" href="mailto:filipkarlberg1@gmail.com">
